...
> Instruções: copie este arquivo, renomeie para `frontend-implementation.md` (substituindo o template) e marque o status de cada tarefa ao longo do desenvolvimento. Ajuste o número de sprints conforme a complexidade do projeto.
