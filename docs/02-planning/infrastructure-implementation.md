...
| I-02 | Dockerfile frontend web (multi-stage com Nginx) | — | ⬜ |
| I-03 | Dockerfile desktop (build apenas, se aplicável) | — | ⬜ |
| I-04 | Docker Compose (serviços: backend, web, banco, proxy) | I-01, I-02 | ⬜ |
...
> Instruções: marque o status de cada tarefa ao longo da implementação. Remova áreas não aplicáveis ao projeto.
