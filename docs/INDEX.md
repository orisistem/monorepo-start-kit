...
| **Ver planos de implementação**           | `docs/02-planning/`                                              | Escolher frente (backend, frontend, mobile, infra)    |
| **Implementar backend**                   | `docs/02-planning/backend-implementation.md`                     | `docs/10-ai-workflow/05-fluxo-desenvolvimento.md`     |
| **Implementar frontend**                  | `docs/02-planning/frontend-implementation.md`                    | `docs/10-ai-workflow/05-fluxo-desenvolvimento.md`     |
...
| Frontend implementation plan | `docs/02-planning/frontend-implementation.md`       | Tech Spec, PRD                                |
