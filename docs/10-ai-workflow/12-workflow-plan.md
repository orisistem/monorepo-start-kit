...
1. **Integração DDD + IA**: O fluxo de business discovery (`02`) é o diferencial mais maduro — domain discovery, linguagem ubíqua, event storming e bounded context mapping com IA *antes* de qualquer código. Isso evita o problema clássico de IA gerar código desalinhado com o negócio.
